...
class VendorSupabaseUser extends BaseAuthUser {
  VendorSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> vendorSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = VendorSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
